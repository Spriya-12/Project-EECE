module dual_port_ram (
    input logic clk,
    input logic [3:0] addr_a, addr_b,   // 4-bit addresses
    input logic [7:0] data_in_a, data_in_b,   // 8-bit data inputs
    input logic we_a, we_b,             // Write enable for each port
    output logic [7:0] data_out_a, data_out_b // 8-bit data outputs
);
...
module tb_dual_port_ram();
    ...
    logic clk;
    logic [3:0] addr_a, addr_b;   // 4-bit addresses
    logic [7:0] data_in_a, data_in_b;   // 8-bit data inputs
    logic we_a, we_b;             // Write enable signals
    logic [7:0] data_out_a, data_out_b;   // 8-bit data outputs
    ...
    initial begin
        ...
        #10;
        addr_a = 4'b0001; we_a = 1; data_in_a = 8'b11001100; // Write 11001100 to address 1 on port A
        ...
        addr_b = 4'b0010; we_b = 1; data_in_b = 8'b00110011; // Write 00110011 to address 2 on port B
        ...
        addr_a = 4'b0011; we_a = 1; data_in_a = 8'b11001100; // Write 11001100 to address 3 on port A
        addr_b = 4'b0011; we_b = 1; data_in_b = 8'b00110011; // Write 00110011 to address 3 on port B
